/**
 * Swizzled SchemaTabs — ESM re-implementation of the upstream CommonJS component.
 *
 * The compiled lib/ version shipped by docusaurus-theme-openapi-docs uses
 * CommonJS `exports`, which webpack treats as ESM in the browser bundle,
 * causing "exports is not defined" at runtime. This file provides the same
 * functionality as native ESM so webpack handles it correctly.
 *
 * Based on docusaurus-theme-openapi-docs v4.7.1 SchemaTabs/index.tsx
